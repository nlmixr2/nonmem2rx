...
rxSolve.nonmem2rx <- function(object, params = NULL, events = NULL, 
    ...
    ..., cores, covsInterpolation = c("locf", "linear", "nocb", 
        "midpoint"), naInterpolation = c("locf", "nocb"), addlKeepsCov = FALSE, 
    addlDropSs = TRUE, ssAtDoseTime = TRUE, safeZero = TRUE, 
    safePow = TRUE, safeLog = TRUE, ss2cancelAllPending = FALSE, 
