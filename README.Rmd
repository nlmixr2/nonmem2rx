...
Due to the sheer size of the zipped models for these two nonmem
control stream sources these are excluded to keep the binary below 3
mgs as required by CRAN.
...
However, even though they are not/will not be in the CRAN binaries,
you can test them yourself by:
