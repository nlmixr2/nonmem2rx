...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  # Use the standard print methods instead of nlmixr2extra's knit_print()
  # LaTeX-equation rendering, which errors on this imported model
  # ("cannot handle class, please report a bug: NULL").
