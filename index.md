...
- In both conversions, [automatically make sure the model is translated
...
- [Perform simulations of new
  ...
  from the NONMEM model or even [simulate using the uncertainty in your
  model to simulate new
...
- [Modify the model to calculate derived
  ...
  (like AUC). These parameters slow down NONMEM’s optimization, but can
  help in your simulation scenario.
